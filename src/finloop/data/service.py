...
from . import cache
from .providers import Provider, StooqProvider, YFinanceProvider
from .providers.base import empty_ohlcv
from .quality import QualityReport, reconcile, validate_ohlcv
...
class DataService:
    def __init__(self, primary: Provider | None = None,
        ...
        self.fallback = fallback or StooqProvider()
